shopitems = {
	...
	"Trainers": {
		"name": "Trainers",
		"description": "The bug-stomper that also lets you run away if it's too scary.",
		"price": 30,
		"uses": 60
	},
	"Flypaper": {
	...
	"Organic fertilizer": {
		...
		"description": "Natural stuff to make plants grow healthier. And by natural, we mean it's poop.",
		"price": 75,
